...
<div class="row text-center">
        ...
        <hr>
   <a class="btn btn-warning btn-lg btn-block" id="formButton" type="button"
   href="${pageContext.request.contextPath}/picture/register_picture_form.do">
   <strong>"${pictureVO.keyword}"</strong>에 대한 추억이 있으신가요? 당신의 추억을 공유해주세요!</a>
  </div>
  <div class="row">
  	<div class="col-md-8"><img src="resources/img/tube.jpeg"

    ...
    <div class="modal-body">
      <form id="report" action="report.do">
        <div class="form-group">
          <img src="${pageContext.request.contextPath}/resources/img/${requestScope.picturevo.path}" style="height: 200px;">
        </div>
        <div class="caption">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" cols="50" rows="10" name="reportContent" required></textarea>
        </div>

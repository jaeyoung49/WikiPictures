        ...
        <ul class="pagination active hidden-xs pull-right">
          <c:choose>
            <c:when test="${pb.previousPageGroup}">
              <li>
                <a aria-label="Previous" href="${pageContext.request.contextPath}/show_picture_list.do?pageNo=${pb.startPageOfPageGroup-1}">
          ...
          <c:forEach var="i" begin="${pb.startPageOfPageGroup}" end="${pb.endPageOfPageGroup}">
            <c:choose>
              ...
              <c:otherwise>
                <li><a href="${pageContext.request.contextPath}/show_picture_list.do?pageNo=${i}">${i}</a></li>
              </c:otherwise>
            </c:choose>
          </c:forEach>
          <c:choose>
            <c:when test="${pb.nextPageGroup}">
              <li>
                <a aria-label="Next" href="${pageContext.request.contextPath}/show_picture_list.do?pageNo=${pb.endPageOfPageGroup+1}">

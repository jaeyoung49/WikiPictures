	...
	<p class="paging">
	 ...
	 -->
		<c:if test="${pb.previousPageGroup}">
			<a
				href="${pageContext.request.contextPath}/show_member_list.do?pageNo=${pb.startPageOfPageGroup-1}">
		...
		<c:forEach var="i" begin="${pb.startPageOfPageGroup}"
			...
			<c:choose>
				<c:when test="${pb.nowPage!=i}">
					<a
						href="${pageContext.request.contextPath}/show_member_list.do?pageNo=${i}">${i}</a>
				</c:when>
				<c:otherwise>
	${i}
	</c:otherwise>
	...
	&nbsp;
	 ...
	 -->
		<c:if test="${pb.nextPageGroup}">
			<a
				href="${pageContext.request.contextPath}/show_member_list.do?pageNo=${pb.endPageOfPageGroup+1}">

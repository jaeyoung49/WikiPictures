...
<ul class="nav nav-tabs nav-justified" style="margin-bottom: 20px;">
  ...
  <li role="presentation"><a href="${pageContext.request.contextPath}/showSecretreplyList.do">시크릿댓글목록보기</a></li>
      ...
      <div class="container-fluid">
        ...
        <ul class="pagination active hidden-xs pull-right">
          ...
          <c:when test="${pb.previousPageGroup}">
            <li><a aria-label="Previous" href="${pageContext.request.contextPath}/showMypictureList.do?pageNo=${pb.startPageOfPageGroup-1}">
          ...
          <c:when test="${pb.nextPageGroup}">
            <li><a aria-label="Next" href="${pageContext.request.contextPath}/showMypictureList.do?pageNo=${pb.endPageOfPageGroup+1}">

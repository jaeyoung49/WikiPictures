...
<p class="paging">
	...
	<a href="${pageContext.request.contextPath}/showBuyList.do?pageNo=${i}">${i}</a> 
	</c:when>
	<c:otherwise>
	${i}
	</c:otherwise>
	...
	<a href="${pageContext.request.contextPath}/showBuyList.do?pageNo=${pb.endPageOfPageGroup+1}">

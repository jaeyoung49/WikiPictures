...
<form method="post" action="${pageContext.request.contextPath}/updateMember.do" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <input class="form-control" type="text" name="password" value="${sessionScope.mvo.password}">
  </div>
  <div class="form-group">
    <label for="exampleInputFile">닉네임</label>
	<input class="form-control" type="text" name="nickname" value="${sessionScope.mvo.nickname}">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
	...
	<input class="form-control" type="text" name="favoriteSpace" value="${sessionScope.mvo.favoriteSpace}">
  </div>
